...
auth_channel = environ.get('-1002360993819')
...
support_chat_id = environ.get('-1002383933038')
reqst_channel = environ.get('-1002360993819')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shemmuz1520:shemmuz1520@cluster0.hanig.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
IS_VERIFY = is_enabled((environ.get('IS_VERIFY', 'False')), False)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "Nop")
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'hey')
SHORTLINK_API = environ.get('SHORTLINK_API', 'hey')
